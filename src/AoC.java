    ...
    public int getResult (){
        ...
        try {
            ...
            switch (dayNo){
                ...
                case 10:
                    Day10 task10 = new Day10 (file);
                    if (testNo == 1)
                        result = task10.doTaskOne();
                    else {
                        result = task10.doTaskTwo();
                    }
                    break;

                case 11:
                    Day11 task11 = new Day11 (file);
                    if (testNo == 1)
                        result = task11.doTaskOne();
                    else {
                        result = task11.doTaskTwo();
                    }
                    break;
